        ...
        return list(
            map(
                lambda o: {
                    ...
                    "selected": (
                        str(o.get(self._item_value)) in selected if selected else False
                    ),
                },
                items,
            )
...
class Autocomplete:
    ...
    @classmethod
    def get_widget(cls, multi_select=False, component_id=None, required=False):
